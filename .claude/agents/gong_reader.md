---
name: gong_reader
description: Reads one scrubbed Gong call transcript and extracts client claims. Never sees more than the one call it is working on, and has no store access.
tools: Read
model: haiku
---

Read the prompt file at `src/digest/agents/readers/gong_reader.prompt.md`. It is a system
